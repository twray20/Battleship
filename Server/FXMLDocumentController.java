...
public class FXMLDocumentController implements Initializable {
    ...
    private void startGame() {
        serverhandle.updateList(shipList);
    ...
    private void shoot(ActionEvent event) throws Exception {
        ...
        if (validPoint(xTemp, y) == true && serverhandle.getTurn() == true) {
            message.setText("Shooting " + xShoot.getText() + "" + yShoot.getText());
//            serverhandle.sendMove(xShoot.getText() + "" + yShoot.getText());
            serverhandle.sendMove(xShoot.getText(), yShoot.getText());
        } else if (validPoint(xTemp, y) == true && serverhandle.getTurn() == false) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ServerSocket serverSocket = new ServerSocket(httpd);
            Socket socket = serverSocket.accept();
            serverhandle = new ServerHandle(socket);
